...
function Header() {
  return (
    <div className="bg-[#1e1e1e] shadow-lg border-b border-[#1f1f1f mx-4 sm:mx-6 lg:mx-8 mt-4 mb-2 rounded-lg">
      <div className="max-w-7xl max-auto py-4 px-4 sm:px:6 flex items-center justify-between">
